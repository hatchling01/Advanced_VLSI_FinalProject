...
set out_dir [file join $root_dir reports e62_fir29_fr_accstart]

file mkdir $out_dir
cd $root_dir

create_project -force e62_fir29_fr_accstart_synth [file join $out_dir vivado_synth] -part xc7a35tcpg236-1
...
synth_design -top lockin_pipelined_plus5_firout_accbuf_energy62_fir29_fastround_accstart_top -part xc7a35tcpg236-1
...
write_checkpoint -force [file join $out_dir e62_fir29_fr_accstart_synth.dcp]
close_project
