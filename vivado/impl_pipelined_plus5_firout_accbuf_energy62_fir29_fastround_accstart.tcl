...
set out_dir [file join $root_dir reports e62_fir29_fr_accstart_impl]
set part_name xc7a35tfgg484-1

file mkdir $out_dir
cd $root_dir

create_project -force e62_fir29_fr_accstart_impl [file join $out_dir vivado_impl] -part $part_name
...
synth_design -top lockin_pipelined_plus5_firout_accbuf_energy62_fir29_fastround_accstart_top -part $part_name
...
write_checkpoint -force [file join $out_dir e62_fir29_fr_accstart_routed.dcp]
close_project
