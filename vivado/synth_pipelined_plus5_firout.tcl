...
set out_dir [file join $root_dir reports pipelined_plus5_firout]

file mkdir $out_dir
cd $root_dir

create_project -force lockin_pipelined_plus5_firout_synth [file join $out_dir vivado_synth] -part xc7a35tcpg236-1
...
synth_design -top lockin_pipelined_plus5_firout_top -part xc7a35tcpg236-1
...
write_checkpoint -force [file join $out_dir lockin_pipelined_plus5_firout_synth.dcp]
close_project
