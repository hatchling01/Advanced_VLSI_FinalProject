...
set sim_dir [file join $root_dir reports e62_fir29_fr_accstart vivado_sim]
set xsim_run_dir [file join $sim_dir e62_fir29_fr_accstart_sim.sim sim_1 behav xsim]

file mkdir $sim_dir
cd $root_dir

create_project -force e62_fir29_fr_accstart_sim $sim_dir -part xc7a35tcpg236-1
...
read_verilog -sv [list \
    ...
    [file join $root_dir rtl lockin_pipelined_plus5_firout_accbuf_energy62_fir29_fastround_accstart_top.sv] \
    [file join $root_dir tb tb_lockin_pipelined_plus5_firout_accbuf_energy62_fir29_fastround_accstart.sv] \
]

set_property top tb_lockin_pipelined_plus5_firout_accbuf_energy62_fir29_fastround_accstart [get_filesets sim_1]
