...
set out_dir [file join $root_dir reports pipelined_plus5_firout_accbuf_trackercmp_impl]
set part_name xc7a35tfgg484-1

file mkdir $out_dir
cd $root_dir

create_project -force lockin_pipelined_plus5_firout_accbuf_trackercmp_impl [file join $out_dir vivado_impl] -part $part_name
...
synth_design -top lockin_pipelined_plus5_firout_accbuf_trackercmp_top -part $part_name
...
write_checkpoint -force [file join $out_dir lockin_pipelined_plus5_firout_accbuf_trackercmp_routed.dcp]
close_project
