...
REM
REM Generated by Vivado on Sun May 03 15:01:56 -0400 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_lockin_baseline_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_lockin_baseline_vlog.prj -log xvlog.log
