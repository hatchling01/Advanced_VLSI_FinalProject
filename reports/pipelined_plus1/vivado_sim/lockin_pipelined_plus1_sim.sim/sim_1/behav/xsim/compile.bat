...
REM
REM Generated by Vivado on Sun May 03 16:24:36 -0400 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_lockin_pipelined_plus1_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_lockin_pipelined_plus1_vlog.prj -log xvlog.log
