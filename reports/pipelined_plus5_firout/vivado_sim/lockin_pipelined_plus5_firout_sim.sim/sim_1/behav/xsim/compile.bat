...
REM
REM Generated by Vivado on Sun May 03 19:03:01 -0400 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_lockin_pipelined_plus5_firout_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_lockin_pipelined_plus5_firout_vlog.prj -log xvlog.log
