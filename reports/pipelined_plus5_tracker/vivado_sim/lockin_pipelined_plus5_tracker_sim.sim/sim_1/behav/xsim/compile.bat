...
REM
REM Generated by Vivado on Sun May 03 17:02:54 -0400 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_lockin_pipelined_plus5_tracker_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_lockin_pipelined_plus5_tracker_vlog.prj -log xvlog.log
