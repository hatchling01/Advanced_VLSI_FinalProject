...
module tb_lockin_pipelined_plus5_firout_accbuf_energy62_fir29_fastround_alwayson_accstart;
    ...
    lockin_pipelined_plus5_firout_accbuf_energy62_fir29_fastround_alwayson_accstart_top #(
