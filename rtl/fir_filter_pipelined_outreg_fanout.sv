...
module fir_filter_pipelined_outreg_fanout #(
    ...
    input  logic                         clk,
    input  logic                         rst,
    (* max_fanout = 128 *) input logic   valid,
    ...
    (* max_fanout = 128 *) logic valid_p1;
    (* max_fanout = 128 *) logic valid_p2;
    (* max_fanout = 128 *) logic valid_p3;
    (* max_fanout = 128 *) logic valid_p4;
    ...
    assign rounded_sum = round_shift(final_sum_reg);
